We visit the url "/index.php?page=member".
We try some random input like quote or comment for example and we see that sql show us the error when executing a wrong query. So this page is vulnerable and we are going to use the error log to get what we want.
...
We retrieve the "countersign" column with "1 union all select 1,group_concat(countersign,0x0a) from users", we get "5ff9d0165b4f92b14994e5c685cdce28" and we follow the instructions. We use "https://md5decrypt.net/", get "FortyTwo", we lower all the char and get "10a16d834f9b1e4068b25c4c46fe0284e99e44dceaf08098fc83925ba6310ff5" in sha256.
