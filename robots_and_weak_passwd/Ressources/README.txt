...
I used the following command "dirb http://192.168.0.30 -o dirb.log". The output is in dirb.log in this directory. With the scan result, we can see two files interesting : robots.txt and the admin page.
